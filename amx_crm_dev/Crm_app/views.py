        ...
        if invoice_number:
            try:
                ...
                invoice_data.update({
                    ...
                    'sum_gst_total_amount':int(add_item.sum_of_igst_percentage+add_item.sum_of_cgst_percentage+add_item.sum_of_sgst_percentage),
                ...
                try:
                    ...
                    invoice_data = {
                        ...
                        'sum_gst_total_amount':int(custom_invoice.sum_of_igst_percentage+custom_invoice.sum_of_cgst_percentage+custom_invoice.sum_of_sgst_percentage),
