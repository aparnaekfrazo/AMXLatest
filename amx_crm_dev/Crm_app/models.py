...
class Drone(models.Model):
    ...
    custom_price = models.ForeignKey(CustomizablePrice, on_delete=models.PROTECT, null=True, blank=True, default=None)
...
class AddItem(models.Model):
    customer_type_id = models.ForeignKey(CustomerCategory, on_delete=models.PROTECT, null=True, blank=True)
    customer_id = models.ForeignKey(CustomUser, on_delete=models.PROTECT, null=True, blank=True, related_name='customer_items')
    owner_id = models.ForeignKey(CustomUser, on_delete=models.PROTECT, null=True, blank=True, related_name='owner_items')
    invoice_type_id = models.ForeignKey(InvoiceType, on_delete=models.PROTECT, null=True, blank=True)
    invoice_status = models.ForeignKey(InvoiceStatus, on_delete=models.PROTECT, null=True, blank=True)
    ...
    # drone = models.ForeignKey(Drone, on_delete=models.PROTECT, null=True, blank=True)
    ...
    owner_email_altr = models.EmailField(max_length=255, blank=True, null=True)
    owner_username = models.CharField(max_length=255, null=True, blank=True)
    owner_mobile_number = models.CharField(max_length=10, null=True, blank=True)
    owner_address = models.TextField(null=True, blank=True)
    owner_pin_code = models.CharField(max_length=255, null=True, blank=True)
    owner_pan_number = models.CharField(max_length=255, null=True, blank=True)
    owner_profile_pic = models.ImageField(upload_to='profile_pics/', null=True, blank=True)
    owner_company_name = models.CharField(max_length=255, null=True, blank=True)
    owner_company_email = models.EmailField(null=True, blank=True)
    owner_company_address = models.CharField(max_length=255, null=True, blank=True)
    owner_shipping_address = models.TextField(null=True, blank=True)
    owner_billing_address = models.TextField(null=True, blank=True)
    owner_company_phn_number = models.CharField(max_length=10, null=True, blank=True)
    owner_company_gst_num = models.CharField(max_length=255, null=True, blank=True)
    owner_company_cin_num = models.CharField(max_length=255, null=True, blank=True)
    owner_company_logo = models.ImageField(null=True, blank=True)
    owner_location = models.TextField(null=True, blank=True)
    owner_gst_number = models.CharField(max_length=255, null=True, blank=True)
    owner_date_of_birth = models.DateTimeField(null=True, blank=True)
    owner_gender = models.CharField(max_length=50, null=True, blank=True)
    owner_shipping_pincode = models.CharField(max_length=50, null=True, blank=True)
    owner_billing_pincode = models.CharField(max_length=50, null=True, blank=True)
    owner_shipping_state = models.CharField(max_length=50, null=True, blank=True)
    owner_shipping_state_code = models.CharField(max_length=50, null=True, blank=True)
    owner_shipping_state_city = models.CharField(max_length=50, null=True, blank=True)
    owner_shipping_state_country = models.CharField(max_length=50, null=True, blank=True)
    owner_billing_state = models.CharField(max_length=50, null=True, blank=True)
    owner_billing_state_code = models.CharField(max_length=50, null=True, blank=True)
    owner_billing_state_city = models.CharField(max_length=50, null=True, blank=True)
    owner_billing_state_country = models.CharField(max_length=50, null=True, blank=True)
    owner_user_signature = models.ImageField(blank=True, null=True)
    owner_gstin_reg_type = models.CharField(max_length=10, null=True, blank=True)
    ...
    customer_email_altr = models.EmailField(max_length=255, blank=True, null=True)
    customer_username = models.CharField(max_length=255, null=True, blank=True)
    customer_mobile_number = models.CharField(max_length=10, null=True, blank=True)
    customer_address = models.TextField(null=True, blank=True)
    customer_pin_code = models.CharField(max_length=255, null=True, blank=True)
    customer_pan_number = models.CharField(max_length=255, null=True, blank=True)
    customer_profile_pic = models.ImageField(upload_to='profile_pics/', null=True, blank=True)
    customer_company_name = models.CharField(max_length=255, null=True, blank=True)
    customer_company_email = models.EmailField(null=True, blank=True)
    customer_company_address = models.CharField(max_length=255, null=True, blank=True)
    customer_shipping_address = models.TextField(null=True, blank=True)
    customer_billing_address = models.TextField(null=True, blank=True)
    customer_company_phn_number = models.CharField(max_length=10, null=True, blank=True)
    customer_company_gst_num = models.CharField(max_length=255, null=True, blank=True)
    customer_company_cin_num = models.CharField(max_length=255, null=True, blank=True)
    customer_company_logo = models.ImageField(null=True, blank=True)
    customer_location = models.TextField(null=True, blank=True)
    ...
    customer_gender = models.CharField(max_length=50, null=True, blank=True)
    customer_shipping_pincode = models.CharField(max_length=50, null=True, blank=True)
    customer_billing_pincode = models.CharField(max_length=50, null=True, blank=True)
    customer_shipping_state = models.CharField(max_length=50, null=True, blank=True)
    customer_shipping_state_code = models.CharField(max_length=50, null=True, blank=True)
    customer_shipping_state_city = models.CharField(max_length=50, null=True, blank=True)
    customer_shipping_state_country = models.CharField(max_length=50, null=True, blank=True)
    customer_billing_state = models.CharField(max_length=50, null=True, blank=True)
    customer_billing_state_code = models.CharField(max_length=50, null=True, blank=True)
    customer_billing_state_city = models.CharField(max_length=50, null=True, blank=True)
    customer_billing_state_country = models.CharField(max_length=50, null=True, blank=True)
    customer_user_signature = models.ImageField(blank=True, null=True)
    customer_gstin_reg_type = models.CharField(max_length=10, null=True, blank=True)
...
class CustomInvoice(models.Model):
    customer_type_id = models.ForeignKey(CustomerCategory, on_delete=models.PROTECT, null=True, blank=True)
    customer_id = models.ForeignKey(CustomUser, on_delete=models.PROTECT, null=True, blank=True,related_name='customer_product_items')
    owner_id = models.ForeignKey(CustomUser, on_delete=models.PROTECT, null=True, blank=True, related_name='owner_product_items')
    invoice_type_id = models.ForeignKey(InvoiceType, on_delete=models.PROTECT, null=True, blank=True)
    e_invoice_status = models.BooleanField(null=True, blank=True, default=False)
    ...
    owner_email = models.EmailField(max_length=50, null=True, blank=True)
    owner_email_altr = models.EmailField(max_length=255, blank=True, null=True)
    owner_username = models.CharField(max_length=255, unique=True, null=True, blank=True)
    owner_mobile_number = models.CharField(max_length=10, null=True, blank=True)
    owner_address = models.TextField(null=True, blank=True)
    owner_pin_code = models.CharField(max_length=255, null=True, blank=True)
    owner_pan_number = models.CharField(max_length=255, null=True, blank=True)
    ...
    owner_shipping_address = models.TextField(null=True, blank=True)
    owner_billing_address = models.TextField(null=True, blank=True)
    owner_company_phn_number = models.CharField(max_length=10, unique=True, null=True, blank=True)
    owner_company_gst_num = models.CharField(max_length=255, null=True, blank=True)
    owner_company_cin_num = models.CharField(max_length=255, null=True, blank=True)
    owner_company_logo = models.ImageField(null=True, blank=True)
    owner_location = models.TextField(null=True, blank=True)
    ...
    customer_email = models.EmailField(max_length=50, null=True, blank=True)
    customer_email_altr = models.EmailField(max_length=255, blank=True, null=True)
    customer_username = models.CharField(max_length=255, unique=True, null=True, blank=True)
    customer_mobile_number = models.CharField(max_length=10, null=True, blank=True)
    customer_address = models.TextField(null=True, blank=True)
    customer_pin_code = models.CharField(max_length=255, null=True, blank=True)
    customer_pan_number = models.CharField(max_length=255, null=True, blank=True)
    ...
    customer_shipping_address = models.TextField(null=True, blank=True)
    customer_billing_address = models.TextField(null=True, blank=True)
    customer_company_phn_number = models.CharField(max_length=10, unique=True, null=True, blank=True)
    customer_company_gst_num = models.CharField(max_length=255, null=True, blank=True)
    customer_company_cin_num = models.CharField(max_length=255, null=True, blank=True)
    customer_company_logo = models.ImageField(null=True, blank=True)
    customer_location = models.TextField(null=True, blank=True)
...
class SlotBookingPrice(models.Model):
    slot_booking_price= models.DecimalField(null=True,blank=True,max_digits=10, decimal_places=2)
    description = models.TextField(null=True, blank=True)
    created_date_time = models.DateTimeField(auto_now_add=True, null=True, blank=True)
    updated_date_time = models.DateTimeField(null=True, blank=True)
    def __str__(self):
...
class Student(models.Model):
    ...
    student_mobile = models.BigIntegerField(null=True, blank=True)
