...
class ModelAdmin(admin.ModelAdmin):
    list_display = ['id','customer_type_id','customer_id','owner_id','invoice_type_id','sum_of_discount_amount',
                    'amount_to_pay','sum_of_sgst_percentage','sum_of_igst_percentage','sum_of_cgst_percentage','ewaybill_status',
...
class ModelAdmin(admin.ModelAdmin):
    list_display = ['id','customer_type_id','customer_id','owner_id','invoice_type_id','sum_of_discount_amount','ewaybill_status',
